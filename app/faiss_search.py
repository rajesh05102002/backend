...
# Load FAISS index
try:
    index = faiss.read_index("C:\\Users\\rajes\\Downloads\\Ai_Agent\\Ai_Agent\\ai_agent\\Data\\vector_database.index")
except Exception as e:
    raise FileNotFoundError("Error loading FAISS index: vector_database.index not found") from e

# Load file names & text chunks
try:
    with open("C:\\Users\\rajes\\Downloads\\Ai_Agent\\Ai_Agent\\ai_agent\\Data\\file_names.pkl", "rb") as f:
        file_names = pickle.load(f)

    with open("C:\\Users\\rajes\\Downloads\\Ai_Agent\\Ai_Agent\\ai_agent\\Data\\text_chunks.pkl", "rb") as f:
